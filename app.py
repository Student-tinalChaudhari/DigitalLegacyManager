...
app = Flask(__namfrom flask import Flask, render_template, request, redirect, url_for, session

app = Flask(__name__)
app.secret_key = "digital-legacy-manager-2026"
...
if __name__ == "__main__":
    app.run(host="0.0.0.0", port=5000)e__)
